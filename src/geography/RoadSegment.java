...
public class RoadSegment {
	...
	public RoadSegment(GeographicPoint pt1, GeographicPoint pt2, 
						List<GeographicPoint> geometry, String roadName,
						String roadType, double length, double averageSpeed)
	{
		point1 = pt1;
		point2 = pt2;
		geometryPoints = new ArrayList<GeographicPoint>(geometry);
	...
	// Populate the averageSpeed field based on road type
    public void calculateAverageSpeed() {
        switch (roadType) {
            case "HIGHWAY":
                setAverageSpeed(100.0); // Assume average speed of 100 km/h on highways
                break;
            case "ARTERIAL":
                setAverageSpeed(60.0); // Assume average speed of 60 km/h on arterials
                break;
            case "SIDE_STREET":
                setAverageSpeed(40.0); // Assume average speed of 40 km/h on side streets
                break;
            default:
                setAverageSpeed(50.0); // Assume average speed of 50 km/h for unknown road types
                break;
        }
    }
