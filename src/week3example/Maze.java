...
public class Maze {
	...
	public List<MazeNode> dfs(int startRow, int startCol, int endRow, int endCol) {
        ...
        // Do the search
        dfs(parentMap, visited, toExplore);
        ...
        return printPath(start, goal, parentMap);
	}

		// reconstruct the path
        private  LinkedList<MazeNode> printPath(MazeNode start, MazeNode goal, HashMap<MazeNode, MazeNode> parentMap)
        {
		...
		// Do the search
        private void dfs(HashMap<MazeNode, MazeNode> parentMap, HashSet<MazeNode> visited, Stack<MazeNode> toExplore)
        {
